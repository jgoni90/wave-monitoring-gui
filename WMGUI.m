...
% Tabs
MainTabs = uitabgroup(MainFigure,'Position',[.165 .2 .675 .8],'Tag','MainTabs');
...
axesLocation = axes('Position',[.01 .72 .15 .25],'Tag','axesLocation','Visible',...
...
axesOmega2D = axes('Position',[.855 .37 .14 .2],'Tag','axesOmega2D','Visible',...
    'on','FontUnits',FontUnits,'FontSize',AxesFontSize,'XGrid','on','YGrid','on'); box on
axesTheta2D = axes('Position',[.855 .08 .14 .2],'Tag','axesTheta2D','Visible',...
    'on','FontUnits',FontUnits,'FontSize',AxesFontSize,'XGrid','on','YGrid','on'); box on

axes3D = axes('Position',[.02 .15 .14 .2],'Tag','axes3D','Visible',...
    'on','FontUnits',FontUnits,'FontSize',AxesFontSize,'XGrid','on','YGrid','on'); box on
...
RectXY = uitoggletool('TooltipString','Rect','CData',...
    iconRead(fullfile('Callbacks/Icons','RectXY.gif')),'Separator','on',...
    'Enable','off');
...
PGD_Panel = uipanel('Title','PGD File Info','FontUnits',FontUnits,'BorderType',BorderType,...
    ...
    'Position',[.01 .61 .15 .1],'FontSize',PanelFontSize,'BackgroundColor',BackgroundColor);
...
View_Panel = uipanel('Title','View Options','FontUnits',FontUnits,'BorderType',BorderType,...
    'TitlePosition','centertop','HighlightColor',PanelBorderColor,...
    'Position',[.01 .42 .15 .18],'FontSize',PanelFontSize,'BackgroundColor',BackgroundColor);
...
%------------- Incident Wave
Input_Panel = uipanel('Title','Incident Wave','Position',[.845 .6 .15 .39],'BorderType',BorderType,...
    'TitlePosition','centertop','HighlightColor',PanelBorderColor,...
...
%------------- Coordinates & Other data
XCoord_Text = uicontrol('Style','text','String',...
    'X','FontUnits',FontUnits,'fontsize',PanelFontSize,...
    'Unit','normalized','HorizontalAlignment','left',...
    'Position',[.72 .15 .01 .05],'BackgroundColor',BackgroundColor);

XCoord_Value = uicontrol('Style','text','String',...
    '0','FontUnits',FontUnits,'fontsize',PanelFontSize,'FontWeight','bold',...
    'Unit','normalized','HorizontalAlignment','left',...
    'Position',[.73 .15 .05 .05],'Enable','off','BackgroundColor',BackgroundColor);

YCoord_Text = uicontrol('Style','text','String',...
    'Y','FontUnits',FontUnits,'fontsize',PanelFontSize,...
    'Unit','normalized','HorizontalAlignment','left',...
    'Position',[.78 .15 .01 .05],'BackgroundColor',BackgroundColor);

YCoord_Value = uicontrol('Style','text','String',...
    '0','FontUnits',FontUnits,'fontsize',PanelFontSize,'FontWeight','bold',...
    'Unit','normalized','HorizontalAlignment','left',...
    'Position',[.79 .15 .05 .05],'Enable','off','BackgroundColor',BackgroundColor);

Average_Text = uicontrol('Style','radiobutton','String',...
    'Avg.','FontUnits',FontUnits,'fontsize',PanelFontSize,...
    'Unit','normalized','HorizontalAlignment','left',...
    'Position',[.17 .176 .05 .025],'BackgroundColor',BackgroundColor);

Average_Value = uicontrol('Style','text','String',...
    'None','FontUnits',FontUnits,'fontsize',PanelFontSize,'FontWeight','bold',...
    'Unit','normalized','HorizontalAlignment','left',...
    'Position',[.22 .15 .07 .05],'Enable','off','BackgroundColor',BackgroundColor);

Minimum_Text = uicontrol('Style','radiobutton','String',...
    'Min.','FontUnits',FontUnits,'fontsize',PanelFontSize,...
    'Unit','normalized','HorizontalAlignment','left',...
    'Position',[.3 .176 .05 .025],'BackgroundColor',BackgroundColor);

Minimum_Value = uicontrol('Style','text','String',...
    'None','FontUnits',FontUnits,'fontsize',PanelFontSize,'FontWeight','bold',...
    'Unit','normalized','HorizontalAlignment','left',...
    'Position',[.35 .15 .07 .05],'Enable','off','BackgroundColor',BackgroundColor);

Maximum_Text = uicontrol('Style','radiobutton','String',...
    'Max.','FontUnits',FontUnits,'fontsize',PanelFontSize,...
    'Unit','normalized','HorizontalAlignment','left',...
    'Position',[.43 .176 .05 .025],'BackgroundColor',BackgroundColor);

Maximum_Value = uicontrol('Style','text','String',...
    'None','FontUnits',FontUnits,'fontsize',PanelFontSize,'FontWeight','bold',...
    'Unit','normalized','HorizontalAlignment','left',...
    'Position',[.48 .15 .07 .05],'Enable','off','BackgroundColor',BackgroundColor);

UserFcn_Text = uicontrol('Style','text','String',...
    'User Function','FontUnits',FontUnits,'fontsize',PanelFontSize,...
    'Unit','normalized','HorizontalAlignment','left',...
    'Position',[.56 .15 .06 .05],'BackgroundColor',BackgroundColor);

UserFcn = uicontrol('Style','popupmenu','FontUnits',FontUnits,'String',...
    {'Select User Function'},'Value',1,'Unit','normalized','Position',[.62 .15 .08 .05],...
...
Omega_Text = uicontrol('Style','text','String',...
    ...
    'Position',[.855 .575 .14 .015],'BackgroundColor',BackgroundColor);

Theta_Text = uicontrol('Style','text','String',...
    'Direction Distribution','FontUnits',FontUnits,'fontsize',PanelFontSize,...
    'Unit','normalized','HorizontalAlignment','center','FontWeight','bold',...
    'Position',[.855 .285 .14 .02],'BackgroundColor',BackgroundColor);

Plot3D_Text = uicontrol('Style','text','String',...
    'Period & Dir. Distribution','FontUnits',FontUnits,'fontsize',PanelFontSize,...
    'Unit','normalized','HorizontalAlignment','center','FontWeight','bold',...
    'Position',[.02 .355 .14 .02],'BackgroundColor',BackgroundColor);

%------------- Output panel
Output_Panel = uipanel('Title','Output','Position',[.17 .01 .67 .1],'BorderType',BorderType,...
    'TitlePosition','centertop','HighlightColor',PanelBorderColor,...
    'FontUnits',FontUnits,'fontsize',PanelFontSize,'BackgroundColor',BackgroundColor);
...
data = struct('dir_struct',dir_struct,'plotid',[],'arrowid',[],'bottomid',[],'arrowdata',arrowdata,'backgroundid',[],...
    ...
    'rectSelection',false,'rectSelectionid',[],'rectIniPoint',[]);
...
set(MainFigure,'WindowButtonDownFcn',{@MainFigureWindowButtonDownFcn,handles},...
               ...
               'WindowScrollWheelFcn',{@MainFigureWindowScrollWheelFcn,handles})
