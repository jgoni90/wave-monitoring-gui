function TabChangeFcn(hObject,eventdata,handles)
...
if data.ButtonFunctionsFlag == true;
    ...
    if strcmp(hObject.SelectedTab.Tag,'Tab1')
        set(handles.UserFcn,'Enable','on')
    ...
    elseif strcmp(hObject.SelectedTab.Tag,'Tab2')
        set(handles.UserFcn,'Enable','off')
    ...
    elseif strcmp(hObject.SelectedTab.Tag,'Tab3')
        set(handles.UserFcn,'Enable','off')
    ...
    elseif strcmp(hObject.SelectedTab.Tag,'Tab4')
        set(handles.UserFcn,'Enable','off')
