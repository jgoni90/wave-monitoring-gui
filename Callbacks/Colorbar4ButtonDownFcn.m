function Colorbar4ButtonDownFcn(hObject,eventdata,handles)
...
if strcmp(get(handles.MainFigure,'SelectionType'),'normal')
    ...
    data.limitid = patch('XData',[handles.axesPlot4.XLim(1) handles.axesPlot4.XLim(2) handles.axesPlot4.XLim(2) handles.axesPlot4.XLim(1)],...
        'YData',[handles.axesPlot4.YLim(1) handles.axesPlot4.YLim(1) handles.axesPlot4.YLim(2) handles.axesPlot4.YLim(2)],...
        'ZData',[limit limit limit limit],...
        'FaceColor','k','FaceAlpha',0.25,'EdgeAlpha',0,'Parent',handles.axesPlot4);
