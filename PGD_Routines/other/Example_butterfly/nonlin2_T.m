function f = nonlin2_T(meshes,mode)

% X1,T1,re1:        THETA mesh
% X2,T2,re2:        D mesh
% X3,T3,re3:        E mesh
% S(D),T(E)         nodal vectors for C and E dimensions to be integrated
% This rotine CANNOT be used also to build the vector for the D or E mesh
...
for ie1 = ve1
    ...
    for ie2 = ve2
        ...
        for ie3 = ve3
            ...
            COEF = bsxfun(@rdivide,X,THETA);
            COEF = sin(COEF);
            COEF = bsxfun(@power,COEF,K);
