function f = nonlin2_D(meshes,mode)

% X1,T1,re1:        D mesh
% X2,T2,re2:        THETA mesh
% X3,T3,re3:        E mesh
% S(THETA),T(E)     nodal vectors for THETA and E dimensions to be integrated
% This rotine CANNOT be used also to build the vector for the THETA or E mesh
...
for ie1 = ve1
    ...
    for ie2 = ve2
        ...
        for ie3 = ve3
            ...
            COEF = bsxfun(@rdivide,K,THETA);
            COEF = sin(COEF);
            COEF = bsxfun(@power,COEF,X);
