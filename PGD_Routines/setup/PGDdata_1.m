...
%File name
PGDfile = 'PGDdata.mataro.K_THETA_ESC[10to16][190to270][0.6to1][50x50x10]';
...
residualEachTerm    = 1;
saveEachTerm        = 10;
outputFile          = 'RB.mataro.K_THETA_ESC[10to16][190to270][0.6to1][50x50x10]_i3';
recoverPGD          = false;
recoverFile         = '';
